...
-(void)saveAction:(id)sender
{
   ...
   int state= [[ScheduleConn getScheduleConn] createHelperSchedule:hobject];
    if (state==0) {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:[StringUtil getLocalizableString:@"schedule_create_succusess"] message:nil delegate:nil cancelButtonTitle:[StringUtil getLocalizableString:@"confirm"] otherButtonTitles: nil];
        [alert show];
        [alert release];
    ...
    {
        UIAlertView *alert=[[UIAlertView alloc]initWithTitle:[StringUtil getLocalizableString:@"schedule_create_fail"] message:nil delegate:nil cancelButtonTitle:[StringUtil getLocalizableString:@"confirm"] otherButtonTitles: nil];
        [alert show];
        [alert release];
    }
...
- (void)viewDidLoad
{
    ...
    if (!self.is_from_group) {
        ...
        self.dataArray=[NSMutableArray arrayWithObjects:nowUser, nil];
    }
...
//    self.titleField.layer.borderWidth= 0.5f;
    ...
    self.placeholderlabel=[[UILabel alloc]initWithFrame:CGRectMake(7,10,200, 20)];
    self.placeholderlabel.text = [StringUtil getLocalizableString:@"schedule_detail"];
    ...
    self.ringLabel.text=[StringUtil getLocalizableString:@"schedule_no_remind"];
    ...
    imagebutton11.image=[StringUtil getImageByResName:@"selected.png"];
