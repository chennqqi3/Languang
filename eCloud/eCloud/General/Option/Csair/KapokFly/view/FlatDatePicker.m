...
#define kFlatDatePickerBackgroundColor [UIColor whiteColor]
#define kFlatDatePickerBackgroundColorTitle [UIColor colorWithRed:51.0/255.0 green:133.0/255.0 blue:210.0/255.0 alpha:1.0]
...
#define kFlatDatePickerBackgroundColorButtonCancel [UIColor colorWithRed:0/255.0 green:105/255.0 blue:197/255.0 alpha:1.0]

#define kFlatDatePickerBackgroundColorScrolView [UIColor colorWithRed:235/255.0 green:240/255.0 blue:244/255.0 alpha:1]
#define kFlatDatePickerBackgroundColorLines [UIColor grayColor]
...
#define kFlatDatePickerFontColorLabel [UIColor lightGrayColor]
#define kFlatDatePickerFontColorLabelSelected [UIColor grayColor]
...
-(void)setupControl {
    ...
    if (self.datePickerMode == FlatDatePickerModeDate) {
        ...
        [self buildSelectorDaysOffsetX:(kFlatDatePickerScrollViewDaysWidth + kFlatDatePickerScrollViewMonthWidth + 2*kFlatDatePickerScrollViewLeftMargin) andWidth:(self.frame.size.width - (kFlatDatePickerScrollViewDaysWidth + kFlatDatePickerScrollViewMonthWidth + 3*kFlatDatePickerScrollViewLeftMargin))];
        [self buildSelectorMonthsOffsetX:(kFlatDatePickerScrollViewDaysWidth + kFlatDatePickerScrollViewLeftMargin) andWidth:kFlatDatePickerScrollViewMonthWidth];
       
        [self buildSelectorYearsOffsetX:0.0 andWidth:kFlatDatePickerScrollViewDaysWidth];
...
- (void)buildHeader {
    ...
    // Button Cancel
    _buttonClose = [[UIButton alloc] initWithFrame:CGRectMake(0.0, 0.0, kFlatDatePickerButtonHeaderWidth+10, kFlatDatePickerHeaderHeight)];
    ...
    // Button Valid
    _buttonValid = [[UIButton alloc] initWithFrame:CGRectMake(self.frame.size.width - kFlatDatePickerButtonHeaderWidth-10, 0.0, kFlatDatePickerButtonHeaderWidth+10, kFlatDatePickerHeaderHeight)];
    _buttonValid.backgroundColor = kFlatDatePickerBackgroundColorButtonCancel;
   // [_buttonValid setImage:[UIImage imageNamed:kFlatDatePickerIconValid] forState:UIControlStateNormal];
    ...
    _buttonValid.titleLabel.font=[UIFont systemFontOfSize:14];
    ...
    // Label Title
    _labelTitle = [[UILabel alloc] initWithFrame:CGRectMake(kFlatDatePickerButtonHeaderWidth+10, 0.0, self.frame.size.width - ((kFlatDatePickerHeaderHeight+10) * 2), kFlatDatePickerHeaderHeight)];
...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (scrollView.tag == TAG_DAYS&&index<_labelsDays.count) {
        [self highlightLabelInArray:_labelsDays atIndex:index];
    } else if (scrollView.tag == TAG_MONTHS&&index<_labelsMonths.count) {
        [self highlightLabelInArray:_labelsMonths atIndex:index];
    } else if (scrollView.tag == TAG_YEARS&&index<_labelsYears.count) {
