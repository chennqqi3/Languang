...
-(void)highButtonPressed:(id)sender
{
    ...
    if (self.selectedArea!=nil) {
        ((zoneChooseViewController *)self.delegete).countryLabel.text=self.selectedArea.areaName;
       
        if (((zoneChooseViewController *)self.delegete).country_id!=self.selectedArea.areaId) {
          ((zoneChooseViewController *)self.delegete).country_id=self.selectedArea.areaId;
            ((zoneChooseViewController *)self.delegete).province_id=-1;
            ((zoneChooseViewController *)self.delegete).provinceLabel.text=@"请选择";
...
- (void)viewDidLoad
{
    ...
    self.chooseArray=[advanceQueryDAO getAllArea:0];
