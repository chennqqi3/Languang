...
{
    UITapGestureRecognizer *tapGestureRecognizer1 = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(performDelegate)];
...
{
    if (_photoDelegate && [_photoDelegate respondsToSelector:@selector(popToLastController)])
    {
        [_photoDelegate popToLastController];
    }
}
