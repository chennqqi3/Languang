...
- (id)initWithDelegate:(id)delegate {
    ...
    if (self) {
        ...
        [self setImage:[StringUtil getImageByResName:@"checkbox_unchecked.png"] forState:UIControlStateNormal];
        [self setImage:[StringUtil getImageByResName:@"checkbox_checked.png"] forState:UIControlStateSelected];
