...
- (void)dismissAnimated:(BOOL)animated completion:(void (^)(void))completion {
    ...
    // 发通知显示tabar
    [[NSNotificationCenter defaultCenter] postNotificationName:BGY_PIC_DISMISS_FINISH_NOTIFICATION object:nil];
    ...
    [UIView animateWithDuration:animated ? 0.2 : 0 delay:0 options:UIViewAnimationOptionBeginFromCurrentState|UIViewAnimationOptionCurveEaseOut animations:^{
        ...
        if (isFromImageClipped) {
            ...
            CGFloat adjustY = 20;
            cell.imageContainerView.center = CGPointMake(CGRectGetMidX(fromFrame), CGRectGetMinY(fromFrame)+adjustY);
            cell.imageContainerView.layer.transformScale = scale;
...
//        [UIView animateWithDuration: delay:0 options:UIViewAnimationOptionCurveLinear animations:^{
//            self.alpha = 0;
//        } completion:^(BOOL finished) {
//            cell.imageContainerView.layer.anchorPoint = CGPointMake(0.5, 0.5);
//            [self removeFromSuperview];
