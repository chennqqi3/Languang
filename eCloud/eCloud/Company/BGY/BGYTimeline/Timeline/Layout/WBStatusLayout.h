...
#define BGY_PIC_DISMISS_FINISH_NOTIFICATION @"BGY_PIC_DISMISS_FINISH_NOTIFICATION"

// 宽高

#define kWBLikeViewHeight 35    // 点赞的人高度
#define kWBCommentBtnWidth 25   // 查看更多按钮的高度

#define kWBCellTopMargin 0      // cell 顶部灰色留白
#define kWBCellTitleHeight 36   // cell 标题高度 (例如"仅自己可见")
#define kWBCellPadding 12       // cell 内边距
#define kWBCommentPadding 22    // 评论的内边距
...
#define kWBCellContentWidth (kScreenWidth - 2 * kWBCellPadding) // cell 内容的宽度
#define kWBCommentContentWidth ((kScreenWidth - 2 * kWBCommentPadding)+5) // 评论的宽度
...
#define kWBCellToolbarHeight 25     // cell 下方工具栏高度
#define kWBCellToolbarBottomMargin 1 // cell 下方灰色留白
...
#define kWBCellHighlightColor UIColorHex(ffffff)     // Cell高亮时白色   UIColorHex(f0f0f0)灰色
#define kWBCellInnerViewColor UIColorHex(ffffff)   // Cell内部卡片灰色    UIColorHex(f7f7f7)灰色
