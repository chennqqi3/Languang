...
@property (nonatomic, strong) YYLabel *sendTimeLabel;
...
@property (nonatomic, strong) YYLabel *textLabel;               // 评论内容 文本
@property (nonatomic, strong) UIView *likeView;                 // 展示点赞的人的view
@property (nonatomic, strong) YYLabel *likesLabel;              // 点赞的人
@property (nonatomic, strong) UIButton *moreComment;            // 查看更多评论
@property (nonatomic, strong) UIView *commentBackgroundView;    // 评论下面的灰色背景
