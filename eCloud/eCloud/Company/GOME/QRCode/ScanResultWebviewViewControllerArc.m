...
@interface ScanResultWebviewViewControllerArc ()<WKUIDelegate,WKNavigationDelegate>
...
@implementation ScanResultWebviewViewControllerArc
...
- (void)webView:(WKWebView *)webView didFinishNavigation:(WKNavigation *)navigation
{
    ...
    if (self.webview && [self.webview.title isEqualToString:@"创客课堂"])
    {
