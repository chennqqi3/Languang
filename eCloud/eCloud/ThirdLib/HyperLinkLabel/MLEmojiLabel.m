...
const CGFloat kEmojiWidthRatioWithLineHeight = 1.1;//和字体高度的比例
...
- (void)setCustomEmojiPlistName:(NSString *)customEmojiPlistName
{
    ...
    if (customEmojiPlistName&&customEmojiPlistName.length>0) {
        ...
        NSString *emojiFilePath = [[_bundle resourcePath] stringByAppendingPathComponent:customEmojiPlistName];
