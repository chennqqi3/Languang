...
int setIsRecord(BOOL _isRecord)
{
    isRecord = _isRecord;
    return 0;
}

#pragma mark add by lyong 2012-11-22
// 将AMR文件解码成WAVE文件
int DecodeAMRFileToWAVEFile(NSString * path,NSString *docFilePath)
{
	FILE* fpamr = NULL;
	FILE* fpwave = NULL;
	char magic[8];
	...
	//NSString * path = [[NSBundle mainBundle] pathForResource:@"20121121_06104060451" ofType:@"amr"];
...
//	NSString *docFilePath        = [documentPath stringByAppendingPathComponent:[NSString stringWithFormat:@"%@", pchWAVEFilename]];
	NSLog(@"documentPath=%@", docFilePath);
