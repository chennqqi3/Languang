...
- (NSMutableAttributedString *)attrStringFromMarkup:(NSString*)markup
{
    ...
    for (NSTextCheckingResult* b in chunks)
    {
        ...
        CTFontRef fontRefTemp = CTFontCreateWithName((CFStringRef)self.font,
                                                     16.0f, NULL);
        CTFontRef fontRef = CTFontCreateCopyWithSymbolicTraits(fontRefTemp, 16, NULL, kCTFontItalicTrait, kCTFontBoldTrait);
        //    long number = 0;
