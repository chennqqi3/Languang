...
- (void)_setupNavigationBar{
    ...
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:[StringUtil getLocalizableString:@"GKIuse"]
...
- (void)_setupCancelButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.cancelButton setTitle:[StringUtil getLocalizableString:@"GKIcancel"] forState:UIControlStateNormal];
...
- (void)_setupUseButton{
    ...
    if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
        ...
        [self.useButton setTitle:[StringUtil getLocalizableString:@"GKIuse"] forState:UIControlStateNormal];
...
- (UIImage *)_toolbarBackgroundImage{
    ...
    UIGraphicsBeginImageContextWithOptions(CGSizeMake(SCREEN_WIDTH, 54), YES, 0.0);
...
- (void)_setupToolbar{
    if (UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        if (floor(NSFoundationVersionNumber) > NSFoundationVersionNumber_iOS_6_1) {
            ...
            info.text = [StringUtil getLocalizableString:@"GKImoveAndScale"];
        }
...
- (void)viewDidLoad{
    ...
    self.title = [StringUtil getLocalizableString:@"GKIchoosePhoto"];
...
- (void)viewWillLayoutSubviews{
    ...
    self.toolbar.frame = CGRectMake(0, CGRectGetHeight(self.view.frame) - 54, SCREEN_WIDTH, 54);
}
